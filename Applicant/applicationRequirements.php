...
<body>
  <div class="app-container">
   ...
   <main class="form-container" tabindex="0" role="main" aria-label="Student Assistance Requirements and Programs">
   <section id="requirements" class="bg-white rounded-lg shadow-md p-8 paper-shadow">
    <h2 class="text-3xl font-bold text-blue-900 mb-6 text-center">
     Student Assistance Requirements
    </h2>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
     <div>
      <h3 class="text-xl font-semibold mb-4 border-b border-blue-300 pb-2">
       Requirements
      </h3>
      <ul class="list-disc list-inside space-y-2 text-gray-700 text-lg">
       <li>
        Accomplished Application Form (to be secured from the Office of Admission &amp; Scholarship)
       </li>
       <li>
       ...
       <li>
        Photocopy of Form 138 or Report of Grades
       </li>
       <li>
      ...
      <img alt="A young student sitting at a desk filling out an application form with a pen, surrounded by books and a laptop" class="mt-8 rounded-lg shadow-md w-full object-cover" height="300" src="https://storage.googleapis.com/a1aa/image/613e099c-95f8-4a9e-786e-da1aa9600366.jpg" width="600"/>
     </div>
     <div>
      <h3 class="text-xl font-semibold mb-4 border-b border-blue-300 pb-2">
       Programs need to enroll
      </h3>
      <div class="mb-8">
      ...
      <div>
       ...
       <img alt="Modern university campus building with students walking and trees around, bright sunny day" class="mt-8 rounded-lg shadow-md w-full object-cover" height="300" src="https://storage.googleapis.com/a1aa/image/deb7d0cd-0263-4d01-3398-ced585cb79c0.jpg" width="600"/>
      </div>
     </div>
    </div>
   </section>
